      ...
      <div className="md:px-48 md:py-80 pb-8">
        <div className="flex md:flex-row flex-col px-12">
          <div className="flex-1">
            <div className="font-normal text-7xl py-12">
              My Career So Far
            </div>
            <div className="font-light text-2xl leading-relaxed">
              Always up for a challenge, I have worked for lean start-ups
             the largest start-up accelerator in the world. From
              there, I worked as a freelance
              where I oversaw the design of 30+ mobile and desktop web apps.
            </div>
          </div>
